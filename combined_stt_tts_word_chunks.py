#!/usr/bin/env python3
"""
Combined Speechmatics STT + ElevenLabs TTS - Word-Based Chunking Version
Configurable word-based chunking (2, 3, 4 words per chunk)
"""
...
TIMEOUT_SECONDS = float(os.getenv("TIMEOUT_SECONDS", "2.0"))  # Timeout in seconds
...
async def main():
    """Main function"""
    print("🚀 Starting Combined STT + TTS System - Hybrid Word + Punctuation Chunking")
    print(f"📋 STT: Real-time transcription")

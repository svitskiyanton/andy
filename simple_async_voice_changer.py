#!/usr/bin/env python3
"""
Simple Async Voice Changer
Single-threaded async approach like the successful WebSocket test
"""
...
class SimpleAsyncVoiceChanger:
    ...
    def start_streaming(self):
        """Start the simple async voice changer"""
        ...
        print("🔄 Starting Simple Async Voice Changer...")
        print("   Single-threaded async approach")
        print("   Like the successful WebSocket test")
        ...
        try:
            ...
            print("\n🛑 Stopping simple async voice changer...")
            self.is_running = False
            self._print_latency_report()
        
        self.audio.terminate()
        print("✅ Simple async voice changer stopped")
    ...
    def _print_latency_report(self):
        ...
        print("\n" + "="*60)
        print("📊 SIMPLE ASYNC VOICE CHANGER PERFORMANCE REPORT")
        print("="*60)
    ...
    async def _main_loop(self):
        """Main async loop - handles everything sequentially"""
        print("🔄 Starting main async loop...")
        
        # Start audio recording task
        recording_task = asyncio.create_task(self._audio_recording_loop())
    ...
    async def _audio_recording_loop(self):
        """Audio recording loop with silence detection"""
        try:
    ...
    async def _tts_streaming_async(self, text, pipeline_start, tts_start):
        """Async TTS streaming like the successful test"""
        try:
...
def main():
    """Main function"""
    voice_changer = SimpleAsyncVoiceChanger()
